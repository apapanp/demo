...
public interface TradeRecordService {
    ...
    List<TradeRecord> findTradeRecordByTo_card_idContainsAndDate_time(@Param("ids") List<Integer> inventoryIdList,String startdate,String enddate);
    List<TradeRecord> findTradeRecordByfrom_card_idContainsAndDate_time(@Param("ids") List<Integer> inventoryIdList,String startdate,String enddate);
}
